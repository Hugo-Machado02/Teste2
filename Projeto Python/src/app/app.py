...
from methods import extractData, config, bedrock, extractTxt
import os
...
def resumo():
    ...
    ValArquivos = extractData.lerPDF(local, subdirectory)

    valPrompt = extractTxt.getPrompt()

    result = bedrock.returnResult(valPrompt, ValArquivos)
